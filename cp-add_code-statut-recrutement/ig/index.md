...
| Draft as of 2025-11-27 | *Computable Name*:ECLAIRE |
...
```json
{
  ...
  "id" : "ans.fhir.fr.eclaire",
  "url" : "https://interop.esante.gouv.fr/ig/fhir/eclaire/ImplementationGuide/ans.fhir.fr.eclaire",
  "version" : "0.3.1",
  "name" : "ECLAIRE",
  ...
  "description" : "Implementation Guide pour définir l'API FHIR pour ECLAIRE (Essais CLiniques Accessibles Interconnectés pour la Recherche ouverts à l'Ecosystème)",
  "jurisdiction" : [
    {
      "coding" : [
        {
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "https://interop.esante.gouv.fr/ig/fhir/eclaire/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "resource" : [
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-study-population-vs"
        },
        "name" : "Caractérisation de la population Value Set",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/eclaire-regulation-code-code-system"
        },
        "name" : "Code de régulation de l'essai",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-regulation-code-vs"
        },
        "name" : "Code de régulation Value Set",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/eclaire-study-population-code-system"
        },
        "name" : "Codes pour caractériser la population de l'étude",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/eclaire-group-characteristic-kind-code-system"
        },
        "name" : "Codes pour le type de caractéristique du groupe",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/eclaire-study-party-organization-type-code-system"
        },
        "name" : "Définition des différents types d'organisation des parties prenantes inspiré de http://hl7.org/fhir/research-study-party-organization-type",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/eclaire-study-phase-source-code-system"
        },
        "name" : "Définition des phase de l'essai utilisés dans la base de données ECLAIRE",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/eclaire-study-party-role-code-system"
        },
        "name" : "Définition des rôles des parties prenantes inspiré de http://hl7.org/fhir/research-study-party-role",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/eclaire-study-status-code-system"
        },
        "name" : "Définition des statuts de l'essai utilisés dans la base de données ECLAIRE",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/eclaire-study-phase-code-system"
        },
        "name" : "Définition des type de phase de l'essai cliniques incluant https://hl7.org/fhir/R4/valueset-research-study-phase.html",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/eclaire-study-title-type-code-system"
        },
        "name" : "Définition des types de titre pour l'essai",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CapabilityStatement/eclaire-consommateur"
        },
        "name" : "Eclaire",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-approval-date"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-arm-intervention"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-associated-party-r5"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-contact-address"
        },
        "name" : "ECLAIREContactAddress",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-contact-affiliation"
        },
        "name" : "ECLAIREContactAffiliation",
        "description" : "Extension créée dans le cadre du projet ECLAIRE pour indiquer l'affiliation du contact",
        "exampleBoolean" : false
      },
      {
        "extension" : [
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-contact-name"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-contact-type"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-description-summary-r5"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-group"
        },
        "name" : "ECLAIREGroup",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-label-r5"
        },
        "name" : "ECLAIRELabelR5",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-location"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-outcome-measure-r5"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-recruitment-period"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-recruitment-status"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-researchstudy"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-review-date"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-site-contact-name"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/eclaire-therapeutic-area"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ConceptMap/eclaire-study-phase-concept-map"
        },
        "name" : "FHIR/Eclaire ResearchStudy phase Use Mapping",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ConceptMap/eclaire-study-status-concept-map"
        },
        "name" : "FHIR/Eclaire ResearchStudy status Use Mapping",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/eclaire-reglementation-precision-code-system"
        },
        "name" : "Précision sur la réglementation concernant l'essai",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-reglementation-precision-vs"
        },
        "name" : "Précision sur la réglementation concernant l'essai Value Set",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/eclaire-status-recruitment-code-system"
        },
        "name" : "Statut de recrutement",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-status-recruitment-vs"
        },
        "name" : "Statut de recrutement Value Set",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-type-contact-vs"
        },
        "name" : "Type Contact Value Set",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-group-characteristic-kind-vs"
        },
        "name" : "Type de caractéristique Value Set",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-study-outcome-type-vs"
        },
        "name" : "Type de conséquence Value Set",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/eclaire-type-contact-code-system"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-study-title-type-vs"
        },
        "name" : "Type de titre Value Set",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ResearchStudy/2022-500014-26-00-example"
        },
        "name" : "UNE ETUDE DE PHASE III, RANDOMISEE, OUVERTE, EVALUANT L'EFFICACITE ET LA SECURITE DU GIREDESTRANT EN ASSOCIATION AVEC PHESGO.",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-study-phase-source-vs"
        },
        "name" : "Value Set de la phase de l'essai tel que définie dans la base ECLAIRE",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-study-party-role-vs"
        },
        "name" : "Value Set Eclaire pour les différents rôles des parties impliquées dans l'essai",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-study-party-organization-type-vs"
        },
        "name" : "Value Set Eclaire pour les types de parties",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-study-status-vs"
        },
        "name" : "Value Set Statut Eclaire de l'essai",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-study-phase-vs"
        },
        "name" : "Value Set type de phase de l'essai clinique",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/eclaire-category-vs"
        },
          ...
          "page" : [
            {
              ...
              "title" : "Extraction de données des essais cliniques",
              "generation" : "markdown"
            },
            {
              "extension" : [
              ...
              "title" : "Recherche des essais cliniques sur critères",
              "generation" : "markdown"
            }
          ]
        },
