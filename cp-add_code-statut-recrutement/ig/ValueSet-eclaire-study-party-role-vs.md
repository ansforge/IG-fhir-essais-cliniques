...
* **Value Set Eclaire pour les différents rôles des parties impliquées dans l'essai**
...
| Draft as of 2025-11-27 | *Computable Name*:EclaireStudyPartyRoleVS |
...
* Include tous les codes définis dans [`https://interop.esante.gouv.fr/ig/fhir/eclaire/CodeSystem/eclaire-study-party-role-code-system`](CodeSystem-eclaire-study-party-role-code-system.md)version 📦0.3.1
