...
* **Value Set Eclaire pour les types de parties**

## ValueSet: Value Set Eclaire pour les types de parties (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/eclaire/ValueSet/eclaire-study-party-organization-type-vs | *Version*:0.3.1 |
| Draft as of 2025-11-25 | *Computable Name*:EclaireStudyPartyOrganizationTypeVS |
...
* Include tous les codes définis dans [`https://interop.esante.gouv.fr/ig/fhir/eclaire/CodeSystem/eclaire-study-party-organization-type-code-system`](CodeSystem-eclaire-study-party-organization-type-code-system.md)version 📦0.3.1
