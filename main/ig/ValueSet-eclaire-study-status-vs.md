...
* **Value Set Statut Eclaire de l'essai**

## ValueSet: Value Set Statut Eclaire de l'essai (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/eclaire/ValueSet/eclaire-study-status-vs | *Version*:0.3.1 |
| Draft as of 2025-11-27 | *Computable Name*:EclaireStudyStatusVS |
...
* Include tous les codes définis dans [`https://interop.esante.gouv.fr/ig/fhir/eclaire/CodeSystem/eclaire-study-status-code-system`](CodeSystem-eclaire-study-status-code-system.md)version 📦0.3.1
