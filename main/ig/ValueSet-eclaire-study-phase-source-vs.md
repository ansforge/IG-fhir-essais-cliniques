...
* **Value Set de la phase de l'essai tel que définie dans la base ECLAIRE**
...
| Draft as of 2025-11-27 | *Computable Name*:EclaireStudyPhaseSourceVS |
...
* Include tous les codes définis dans [`https://interop.esante.gouv.fr/ig/fhir/eclaire/CodeSystem/eclaire-study-phase-source-code-system`](CodeSystem-eclaire-study-phase-source-code-system.md)version 📦0.3.1
