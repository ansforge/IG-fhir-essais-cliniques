...
| Draft as of 2025-11-27 | *Computable Name*:EclaireStatusRecruitementVS |
...
* Include tous les codes définis dans [`https://interop.esante.gouv.fr/ig/fhir/eclaire/CodeSystem/eclaire-status-recruitment-code-system`](CodeSystem-eclaire-status-recruitment-code-system.md)version 📦0.3.1
