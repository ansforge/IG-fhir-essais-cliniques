...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/eclaire/ValueSet/eclaire-study-population-vs | *Version*:0.3.1 |
| Draft as of 2025-11-27 | *Computable Name*:EclaireStudyPopulationVS |
...
* Include tous les codes définis dans [`https://interop.esante.gouv.fr/ig/fhir/eclaire/CodeSystem/eclaire-study-population-code-system`](CodeSystem-eclaire-study-population-code-system.md)version 📦0.3.1
